...
export function PanelRight(p: IconProps) {
  return (
    <Svg {...p}>
...
/** Auto-avançar. Com `off`, recebe uma barra diagonal indicando desligado. */
export function Repeat({ off, ...p }: IconProps & { off?: boolean }) {
  return (
    <Svg {...p}>
...
/** Tela cheia: duas setas diagonais apontando para fora (padrão "expand"). */
